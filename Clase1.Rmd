...
- Asignación  
[Discución en stackoverflow](https://stackoverflow.com/questions/1741820/what-are-the-differences-between-and-assignment-operators-in-r)  
[R inferno](https://www.burns-stat.com/pages/Tutor/R_inferno.pdf)  
[Leer más](https://www.roelpeters.be/the-difference-between-arrow-and-equals-assignment-in-r/)   
...
- Workspace y environment (o ambiente): donde aparece la lista de objetos que creamos.  

- Objetos.
- Vectores conjunto de valores del mismo tipo. 
- Clase de los objetos: numerico, logico, caracter.
