...
Este material esta accesible <br> y se encuentra en: mi [`r fa("external-link-alt", fill = "#52b788")`github](https://github.com/MiriamLL/Curso_CIAD/) y mi [`r fa("external-link-alt", fill = "#52b788")`página](https://miriamlerma.netlify.app/materiales.html)
]
...
library(fontawesome)
```
[`r fa("home", fill = '#52b788')`](https://miriamlerma.netlify.app/materiales.html)
]</h1>
