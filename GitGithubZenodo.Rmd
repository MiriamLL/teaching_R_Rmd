...
- Alguien tiene git ya instalado en su computadora?
...
- Una desventaja es que instalacion varia mucho entre computadoras
...
Muchas revistas solicitan incluir datos o codigo en las publicaciones.
...
Todos los datos deben estar publicamente disponibles y ser citados de acuerdo a sus reglamentos. 

- [**PLOS ONE**](https://journals.plos.org/plosone/s/submission-guidelines#loc-data-reporting) requiere que los autores agreguen una seccion que rediriga al repositorio publico donde estan accesibles los datos, o que los datos sean parte del articulo. <br>

**Recomendacion** No incluyan los datos en la publicacion (por motivos de licencia), es mejor tenerlos en un repositorio.
...
En equipo 💃🏽👯 
- Escribir codigo en Rmd para analizar datos de pingüinos. 
- Subir Rmd a github, compartir enlace en drive
