...
.pull-right[
```{r, warning=FALSE, message=FALSE, out.width="70%", echo=FALSE, include=TRUE}
library(datasauRus)
library(ggplot2)
ggplot(datasaurus_dozen,aes(x=x, y=y, colour=dataset))+
  geom_point()+ theme_void()+ theme(legend.position = "none")+
...
```{r, fig.heigth=2, warning=FALSE, message=FALSE, out.width="40%", include=FALSE}
ggplot(Pingus, aes(largo_aleta_mm, masa_corporal_g, 
           color=especie))+ #<<
  geom_point()
```
...
.pull-right[
```{r, fig.heigth=2, warning=FALSE, message=FALSE, out.width="40%",echo=FALSE}
ggplot(Pingus, aes(largo_aleta_mm, masa_corporal_g, 
           color=especie))+ #<<
  geom_point()
```
...
.pull-right[
```{r, fig.heigth=3, warning=FALSE, message=FALSE, echo=FALSE}
ggplot(Pingus, aes(largo_aleta_mm, masa_corporal_g)) +
       geom_point(aes(color =especie))+ #<<
       geom_smooth(method="lm")
```
...
.pull-left[
```{r, warning=FALSE, message=FALSE, out.width="40%", include=FALSE}
...
.pull-right[
```{r, warning=FALSE, message=FALSE, out.width="40%", echo=FALSE}
ggplot(Pingus, aes(largo_aleta_mm, masa_corporal_g, color = especie)) +
       geom_point() +
       geom_smooth(method = "lm") #<<
```
