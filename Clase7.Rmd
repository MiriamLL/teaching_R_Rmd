...
[Portada por Kristine Wook](https://unsplash.com/@kwook)
...
## 1. 6. Ejercicios 
Cargarlos desde el paquete, usar read_csv, o import dataset. 
...
Este paquete tiene muchas funciones para checar supuestos del modelo. Se puede usar por separado check_collinearity(), check_normality(), check_heteroscedasticity() o checar todo junto con check_model().
...
ggplot(data = ex_data_1, aes(x = x, 
                             y = y)) +
  geom_point(color = "black") + # todos los puntos
