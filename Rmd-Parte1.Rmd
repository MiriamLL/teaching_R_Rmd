...
Para cambiar el output, hay que especificarlo en el YAML, o darle click a la flechita `r fa("sort-down", fill = ColorLink)` de Knit y seleccionar la opcion deseada.  
...
Te recomiendo seguir con [`r fa("external-link-alt", fill = ColorLink)`Rmd-Parte2](https://miriamlerma.netlify.app/materiales.html).
