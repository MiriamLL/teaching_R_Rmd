...
y mi [`r fa("external-link-alt", fill = "#ffd166")`página www.miriam-lerma.com](https://www.miriam-lerma.com/materiales.html)
...
library(fontawesome)
```
[`r fa("home", fill = '#ffd166')`](https://www.miriam-lerma.com/materiales.html)
]</h1>
