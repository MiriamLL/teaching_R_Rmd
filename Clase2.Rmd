...
class: title-slide, inverse, bottom
background-image: url(https://images.unsplash.com/photo-1496740019327-63371ac821e4?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=802&q=80)
background-size: cover
...
`r emo::ji("clock")` 10 minutos `r emo::ji("clock")`

Crea un gráfico de puntos con los datos de Pingüinos `r emo::ji("bird")`
...
1.1 Teoría.  
1.2 Gráficos con ggplot.  
1.3. Practica.  
1.4. Tipos de gráfico.
