...
[Portada por Hannah Busing](https://unsplash.com/@hannahbusing)
...
Es **bueno** que se limpie el environment, porque te obliga a reportar todo lo que hiciste... ... y que puedas replicarlo en el futuro. <br>

.center[
<h3>`r fa("exclamation-triangle", fill = "black")`</h3>
]
...
## 1.7. Orden por defecto `r fa("robot", fill = "black")`
