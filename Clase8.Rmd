...
y mi [`r fa("external-link-alt", fill = "#f2cc8f")`página www.miriam-lerma.com](https://www.miriam-lerma.com/materiales.html)
]

<h1>
.right[
[`r fa("home", fill = '#f2cc8f')`](https://www.miriam-lerma.com/materiales.html)
]</h1>
