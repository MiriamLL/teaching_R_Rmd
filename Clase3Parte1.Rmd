...
Esta clase: 
4.1. Operaciones matematicas simples.  
4.2. Funciones basicas (mean, median, sd, range).  
4.3. Funciones tidyverse (count, select).  

Siguiente clase:  
4.4. Funciones tidyverse (filter, group_by, summarize)
4.5. Unir dataframes (join)  
4.6. Exportar dataframes (write_csv)  
