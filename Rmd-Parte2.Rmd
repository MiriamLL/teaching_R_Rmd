...
No tienen que extrañar su editor de texto...
...
Aqui la pagina para ver todas las opciones [`r fa("external-link-alt", fill = ColorLink)`Click aqui](https://github.com/rstudio/rticles)
...
Ejercicio en grupo
- Escribir un artículo sobre pingüinos de Papúa
- Ejemplo con pingüinos de Adelia [`r fa("external-link-alt", fill = ColorLink)`Descargar](https://github.com/MiriamLL/Curso_CIAD/blob/main/PinguinosRmd.html)
