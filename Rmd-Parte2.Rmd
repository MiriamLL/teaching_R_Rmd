...
[`r fa("youtube", fill = ColorLinkInverse)` RLadiesBuenosAires](https://www.youtube.com/watch?v=zENhUzKfCws)

- Tutoriales en ingles:    
[`r fa("youtube", fill = ColorLinkInverse)` RLadiesOslo](https://www.youtube.com/watch?v=Xn5AmUf7gDQ&t=6552s)<br>
[`r fa("youtube", fill = ColorLinkInverse)` RLadiesFreiburg](https://www.youtube.com/watch?v=H91WSwALx1A&t=3777s)<br>
[`r fa("youtube", fill = ColorLinkInverse)` RLadiesJohannesburgo](https://www.youtube.com/watch?v=tSrf4n7DFYI&t=55s)  
