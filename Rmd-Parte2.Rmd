...
[`r fa("external-link-alt", fill = ColorLink)`Rmarkdown por Resul Umit](https://resulumit.com/teaching/rmd_workshop#1)  
...
Aqui la pagina para ver plantillas de varias revistas [`r fa("external-link-alt", fill = ColorLink)`Click aqui](https://github.com/rstudio/rticles)
...
## 6.1. Ejercicios
- Abrir los diferentes plantillas
- Explorar opciones para escribir artículos
...
- Escribir articulo sobre pingüinos de Adelia.

En equipo o individual.
- Escribir articulo sobre pingüinos de Papúa.
...
## 8.4. Escribir articulo
Escribir articulo y exportar documento sin código.
...
Hay muchas otras opciones como gitlab para alojar repositorios.<br>
...
```
--- 
Esto lo podemos incluir ahora en nuestra publicación.  
...
**Data accesibility**  
Dataset to reproduce the analyses and scripts are freely available at zenodo (https://doi.org/10.5281/zenodo.4682898).
