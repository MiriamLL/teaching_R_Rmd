...
y mi [`r fa("external-link-alt", fill = "#219ebc")`página](https://miriamlerma.netlify.app/materiales.html)
]
<h1>
.right[
```{r, echo=FALSE}
library(fontawesome)
```
[`r fa("home", fill = '#219ebc')`](https://miriamlerma.netlify.app/materiales.html)
]</h1>