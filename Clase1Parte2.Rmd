...
y mi [`r fa("external-link-alt", fill = "#9d0208")`página](https://miriamlerma.netlify.app/materiales.html)
...
library(fontawesome)
```
[`r fa("home", fill = '#9d0208')`](https://miriamlerma.netlify.app/materiales.html)
]</h1>
